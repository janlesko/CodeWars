...
# (number of towns to visit, k >= 1) and ls (list of distances, all distances are 
# positive or null integers and this list has at least one element). The function 
# returns the "best" sum ie the biggest possible sum of k distances less than or 
# equal to the given limit t, if that sum exists, or otherwise nil, null, None, 
# Nothing, depending on the language. With C++ return -1.
...
def choose_best_sum(t, k, ls)
  ls.combination(k).map { |com| com.inject(:+) }.select { |com| com <= t }.max
end
